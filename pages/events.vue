    ...
    <div class="flex flex-col max-w-6xl mx-auto gap-y-28 items-center">
      ...
      <div>
        ...
        <p class="font-extralight text-xl text-center">
          ...
          morbi porta justo faucibus laoreet nunc cursus quisque. In sed eget
          faucibus est. Convallis nisi tortor, faucibus quisque mauris netus
          vitae. Consequat commodo sem bibendum dolor ultrices etiam enim nunc
          velit. Lacus ut adipiscing ligula adipiscing pellentesque maecenas
          varius lacus. In eget in duis nibh elementum. Tristique amet, feugiat
          id lacus at et. Nibh.
        </p>
      </div>
      ...
      events: [
        {
          ...
          images: ["/content/hoc.jpg", "/content/codex-logo.png"],
        },
        {
          title: "CodeX",
          date: "March 2021",
          ...
          description:
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
          images: ["/content/codex-logo.png", "/content/hoc.jpg"],
        },
        {
