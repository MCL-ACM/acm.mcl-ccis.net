...
export default function HeroSection() {
  return (
    <div className="">
      ...
      <div className="h-80 bg-top bg-cover relative" style={{ backgroundImage: `url(${background})` }}>
        <svg viewBox="0 0 375 32" className="w-full absolute bottom-0">
        <path d="M0 32.0001H375V0.616211C375 0.616211 110 32.0001 98 32.0001C86 32.0001 0 0.616211 0 0.616211V32.0001Z" fill="#FFFFFF"/>
        </svg>
      </div>
