...
export default function EventModal({ event, tagged, toggle }) {
  ...
  return (
    <div className='absolute'>
      ...
      <div className='fixed max-w-[98%] max-h-[844px] m-auto inset-0 z-50 flex flex-col justify-center items-center py-5'>
        <div className='bg-white max-w-[98%] w-full h-[844px] text-left rounded-3xl flex flex-col pt-7 gap-y-5 border-2 shadow-2xl z-50 shadow-sky-200'>
          <div className='flex flex-col gap-y-4 px-24'>
            ...
            <div className='flex w-full justify-between flex-col space-y-3'>
