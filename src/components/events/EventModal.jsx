  ...
  return (
    <div className='fixed top-0 z-20 flex flex-col w-screen h-screen text-white bg-black'>
      ...
      <div className='flex flex-col h-full justify-between'>
        ...
        <div className='flex flex-col px-6 py-4 sm:py-2 w-full sm:flex-row fixed-width sm:gap-8 sm:items-center'>
          ...
          <div className='sm:max-w-[50%] sm:text-right sm:ml-auto text-left py-6 overflow-y-scroll max-h-[120px]'>
